	...
	<body>
		...
		<div class="mui-content">
			<form id='login-form' class="mui-input-group">
				...
				<div class="mui-input-row">
					<label>身份证号</label>
					<input id='idCord' type="text" class="mui-input-clear mui-input" placeholder="身份证号">
				</div>
			</form>
		...
		<script>
			(function($, doc) {
				...
				//mui.alert('欢迎使用Hello MUI', 'Hello MUI');
					var loginButton = doc.getElementById('login');  //登录
					var userid = doc.getElementById('userId');		//用户名
					var pwb = document.getElementById('password');	// 密码
